...
const products: Product[] = [
  ...
  },
  {
    id: '04',
    dark: true,
    platform: 'TRUST & EVIDENCE INTEGRITY',
    name: 'M-INT',
    ...
    steps: [
      ...
      { num: '02', title: 'Cross-Asset Coherence Analysis', desc: 'Compares all submitted evidence against each other and the claim narrative — catching mismatches single-asset review misses.' },
      { num: '03', title: 'Explainable Risk Verdict', desc: 'Outputs a business-ready decision — Low / Needs Review / High Risk — with explainable indicators and recommended actions.' },
      { num: '04', title: 'Workflow Integration Layer', desc: 'Plugs into claims, KYC, FNOL and underwriting — auto-clears low risk, routes medium, escalates high. No rip-and-replace.' },
    ],
    capabilities: [
      'Computer Vision: Detects manipulation, synthetic content and authenticity signals across all submitted images.',
      'LLM Narrative Analysis: Analyses claim descriptions for consistency, plausibility and narrative-to-evidence alignment.',
      'Cross-Asset Coherence: Compares every piece of submitted evidence against each other and the claim narrative.',
      'Explainable Risk Scoring: Outputs Low / Needs Review / High Risk verdicts with audit-ready reasoning.',
      'Workflow Integration: Plugs into claims, KYC, FNOL and underwriting without rip-and-replace.',
    ],
    outcomes: [
      { label: 'Speed Accelerator', desc: 'Genuine claims get fast-tracked automatically — not just a fraud catcher.' },
      { label: 'Pre-Payout Flagging', desc: 'Manipulated submissions are flagged before payout — not found in post-mortem audits.' },
      { label: 'Focused Investigation', desc: 'Investigators focus on genuinely suspicious cases, not routine submissions.' },
      { label: 'Audit-Ready Decisions', desc: 'Every decision is explainable and audit-ready — essential for insurance compliance.' },
    ],
  },
  {
    id: '03',
